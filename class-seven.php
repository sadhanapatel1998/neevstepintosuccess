        ...
        <div class="header-page-content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Class VII</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="summery-details-item sidebar-to-header">
                    <div class="summery-box">
                        ...
                        <div class="summery-inner">
                            <h3 class="mb-30">Class VII – Concept Development Program</h3>

                            <div class="summery-list">

                                <div class="summery-list-item">
                                    <div class="summery-label"><i class="flaticon-equalizer"></i>Level</div>
                                    <div class="summery-option">Intermediate Foundation</div>
                                </div>
            ...
            <div class="col-12 col-lg-8 pb-30 order-lg-1 order-1">
                <div class="summery-details-item desk-pad-right-30">
                    <div class="mb-30">
                        <img src="assets/images/courses/class-7th.png" alt="Course Image ">
                    </div>
                    <div class="summery-info-details-item summery-info-details-item-active"
                        ...
                        <div class="summery-info-details-inner">
                            <h1>Class 7 Concept Development Program</h1>

                            <p>
                                The Class 7 program focuses on strengthening students' understanding of
                                important academic concepts. At this stage, students begin to explore
                                subjects in greater depth and develop analytical thinking skills.
                            </p>

                            <p>
                                Our experienced teachers ensure that concepts in Mathematics, Science,
                                and English are explained clearly through structured lessons and
                                interactive discussions. Students are encouraged to ask questions
                                and develop curiosity in learning.
                            </p>

                            <h4>Requirements:</h4>

                            <ul>
                                <li><i class="flaticon-check"></i> Understanding of Class 6 fundamentals</li>
                                <li><i class="flaticon-check"></i> Regular participation in classroom activities</li>
                                <li><i class="flaticon-check"></i> Consistent practice and homework completion</li>
                            </ul>

                            <p>
                                With chapter-wise notes, practice worksheets, and weekly assessments,
                                students strengthen their academic skills and improve their performance
