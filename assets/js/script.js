jQuery(
  (function ($) {
    ...
    $(".testimonial-carousel-two").hover(
      function () {
        this.swiper.autoplay.stop();
      },
      function () {
    ...
    // Classes-carousel
    var classesSwiper = new Swiper(".classes-carousel", {
      slidesPerView: 3,
      spaceBetween: 30,
      speed: 1500,
    ...
    // Move pagination on small screens
    if ($(window).width() < 992) {
      $(".classes-pagination").appendTo(".classes-carousel");
    }

    // Pause autoplay on hover
    $(".classes-carousel").hover(
      function () {
        classesSwiper.autoplay.stop();
      },
      function () {
        classesSwiper.autoplay.start();
      },
    );
    // Instagram-carousel
    ...
    $(".product-tab-list li").click(function () {
      ...
      $(
        ".summery-info-details-item[data-summery-info-details=" +
          tab_modal +
          "]",
      )
        .addClass("summery-info-details-item-active")
        .siblings()
        .removeClass("summery-info-details-item-active");
    });
    ...
    $(".profile-information-tab li").click(function () {
      ...
      $(this).addClass("active").siblings().removeClass("active");
      $(
        ".profile-information-details-item[data-profile-information-details=" +
          tab_modal +
          "]",
      )
        .addClass("active")
    ...
    $(".profile-dashboard-tab li").click(function () {
      ...
      $(this).addClass("active").siblings().removeClass("active");
      $(
        ".profile-dashboard-details-item[data-profile-dashboard-details=" +
          tab_modal +
          "]",
      )
        .addClass("active")
...
function setTheme(themeName) {
  localStorage.setItem("jexi_theme", themeName);
  document.documentElement.className = themeName;
}

// function to toggle between light and dark theme
// function toggleTheme() {
//   if (localStorage.getItem("jexi_theme") === "theme-dark") {
